        ...
        <div className="flex-col items-center">
          ...
          <div className="flex flex-col items-center justify-center max-w-2xl py-8 mx-auto xl:flex-row xl:max-w-full">
            <div className="w-full xl:w-1/2 xl:pr-8">
              {/* Testimonial 1 */}
              <blockquote className="flex flex-col-reverse items-center justify-between w-full p-6 text-center transition-all duration-200 bg-gray-100 rounded-lg md:flex-row md:text-left hover:bg-white hover:shadow ease">
              ...
              {/* Testimonial 2 */}
              <blockquote className="flex flex-col-reverse items-center justify-between w-full p-6 mt-16 mb-16 text-center transition-all duration-200 bg-gray-100 rounded-lg md:flex-row md:text-left hover:bg-white hover:shadow ease xl:mb-0">
            ...
            <div className="w-full xl:w-1/2 xl:pl-8">
              ...
              {/* Testimonial 4 */}
              <blockquote className="flex flex-col-reverse items-center justify-between w-full p-6 mt-16 text-center transition-all duration-200 bg-gray-100 rounded-lg md:flex-row md:text-left hover:bg-white hover:shadow ease">
                <div className="flex flex-col pr-10">
                  <div className="relative pl-12">
                    <svg
                      className="absolute left-0 w-10 h-10 text-indigo-500 fill-current"
                      ...
                      viewBox="0 0 100 125"
                    >
                      <path d="M30.7 42c0 6.1 12.6 7 12.6 22 0 11-7.9 19.2-18.9 19.2-11.8 0-19.5-10.5-19.5-21.6 0-19.2 18-44.6 29.2-44.6 2.8 0 7.9 2 7.9 5.4S82.4 31.6 82.4 42z" />
                    </svg>
                    <p className="mt-2 text-base text-gray-600">
                      Finally a quick and easy system I can use for any project.
                    </p>
                  </div>
                  <h3 className="pl-12 mt-3 text-base font-medium leading-5 text-gray-800 truncate">
                    Molly Sanchez{" "}
