  ...
  return (
    <div>
        ...
        <a href="" className="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="https://rst6-livesite.rschooltoday.com/sites/r-pschools.com/files/images/Private_User/laurahahn/R-P-logo_grn-ylw_main-(outlined).jpg" className="h-8" alt="Flowbite Logo" />
            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">R.P School</span>
        </a>
